...
export default function AddScreen() {
    ...
    const showComingSoon = (title: string) => {
        ...
        setMessageSubtitle("This quick-add flow is not built yet. Add Vehicle is ready to use now.");
                ...
                <View style={styles.content}>
                        ...
                        {actions.map((action) => {
                            ...
                            return (
                                <Pressable key={action.key} style={styles.actionCard} onPress={action.onPress}>
                                    <View style={[styles.iconTile, { backgroundColor: action.iconBg }]}>
                    ...
                    <View style={styles.helperCard}>
                        <Text style={styles.helperText}>
                            Choose an action above to quickly add entries to your vehicle records
                        </Text>
                    </View>
                </View>
            </TabScreen>
            ...
            <Modal
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalCard}>
                        ...
                        <Pressable style={styles.modalButton} onPress={() => setMessageVisible(false)}>
